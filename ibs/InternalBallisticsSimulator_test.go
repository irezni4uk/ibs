...
func TestInternalBallisticsSimulator(t *testing.T) {
	...
	p := Projectile{Mass: 1, ForcingPressure: 100e6}
	b := NewBarrel()
	c := NewCharge()
	...
	Vtarget = 1507
	c.Propellant[1] = Propellant{Mass: 1, Force: 1006000, Impulse: 500000, Density: 1600, AdiabaticIndex: 1.224, Covolume: 1.01e-3, BurnTemperature: 2900,
